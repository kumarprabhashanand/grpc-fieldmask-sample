...
type GreetUserServiceClient interface {
	...
	GetRandomUser(ctx context.Context, in *GetRandomUserRequest, opts ...grpc.CallOption) (*GetRandomUserResponse, error)
}
...
func (c *greetUserServiceClient) GetRandomUser(ctx context.Context, in *GetRandomUserRequest, opts ...grpc.CallOption) (*GetRandomUserResponse, error) {
	out := new(GetRandomUserResponse)
	err := c.cc.Invoke(ctx, "/com.grpc.example.GreetUserService/GetRandomUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetUserServiceServer interface {
	...
	GetRandomUser(context.Context, *GetRandomUserRequest) (*GetRandomUserResponse, error)
...
func (UnimplementedGreetUserServiceServer) GetRandomUser(context.Context, *GetRandomUserRequest) (*GetRandomUserResponse, error) {
...
func _GreetUserService_GetRandomUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRandomUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetUserServiceServer).GetRandomUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.grpc.example.GreetUserService/GetRandomUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetUserServiceServer).GetRandomUser(ctx, req.(*GetRandomUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GreetUserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _GreetUserService_GetRandomUser_Handler,
		},
	},
